  ...
  return (
    <section className="bg-white py-20 font-cairo text-right px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-700 text-base">باقتَين شاملة لكل احتياجاتك</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-start gap-8 max-w-5xl mx-auto">
        ...
        <div className="border border-green-600 rounded-2xl p-6 w-full lg:w-[340px] bg-white shadow-md">
          ...
          <div className="text-center mb-6 text-gray-900 text-3xl font-extrabold">
            <span className="ml-2 text-lg text-gray-700 font-medium">جنيه / شهرياً</span>
            195
          </div>
        ...
        <div className="border border-green-600 rounded-2xl p-6 w-full lg:w-[340px] bg-white shadow-md">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-1 text-center">اشتراك سنوي مع زيادة عدد الرسائل</h3>
          <p className="text-gray-600 text-sm mb-4 text-center">
            وفر وادفع لسنة كاملة
          </p>

          <div className="text-center mb-6 text-gray-900 text-3xl font-extrabold">
            <span className="ml-2 text-lg text-gray-700 font-medium">جنيه / سنوي</span>
            190
          </div>
