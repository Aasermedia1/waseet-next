...
const faqData = [
  ...
  },
  {
    ...
    answer:
      'الباقة الأساسية بـ 195جنيه شهرياً، والباقة السنوية بـ 190جنيه تدفعها سنوي بخصم لما تدفع سنوي مرة واحدة.',
  },
  {
...
const FAQSection = () => {
  ...
  return (
    <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 text-right">
      <div className="max-w-4xl mx-auto">
        <h3 className="text-sm text-blue-600 font-bold mb-2">الأسئلة الشائعة</h3>
        <h2 className="text-3xl font-extrabold text-gray-900 mb-4">عندك أسئلة؟ عندنا إجابات</h2>
