  ...
  return (
    <div style={{ padding: '60px 20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: '40px' }}>
        <h2>Built for Egyptian Online Sellers</h2>
        <p>Perfect for small Instagram stores and online businesses in Egypt.</p>
      </div>

      <div style={{ textAlign: 'center', marginTop: '40px', color: 'gray', fontSize: '0.9rem' }}>
        <p><strong>Waseet</strong> is a product by AaserMedia for Web Solution</p>
      </div>
    </div>
  );
}
